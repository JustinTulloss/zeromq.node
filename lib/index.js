...
exports.Socket = function (type) {
  ...
  this.type = type;
  this._zmq = new zmq.SocketBinding(getDefaultContext(), types[type]);
  this._paused = false;
...
Socket.prototype.read = function() {
  ...
  flags = this._zmq.getsockopt(opts.ZMQ_EVENTS);

  if (flags & zmq.ZMQ_POLLIN) {
    do {
      message.push(this._zmq.recv());
    } while (this._zmq.getsockopt(opts.ZMQ_RCVMORE));
...
exports.Context.setMaxThreads = function(value) {
  ...
  getDefaultContext().setOpt(zmq.ctxOptions.ZMQ_IO_THREADS, value);
};
...
exports.Context.getMaxThreads = function() {
  ...
  return getDefaultContext().getOpt(zmq.ctxOptions.ZMQ_IO_THREADS);
};
...
exports.Context.setMaxSockets = function(value) {
  ...
  getDefaultContext().setOpt(zmq.ctxOptions.ZMQ_MAX_SOCKETS, value);
};
...
exports.Context.getMaxSockets = function() {
  ...
  return getDefaultContext().getOpt(zmq.ctxOptions.ZMQ_MAX_SOCKETS);
};
