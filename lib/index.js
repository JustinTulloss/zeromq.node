  ...
  try {
    while (true) {
      ...
      if (flags & zmq.ZMQ_POLLIN) {
          ...
          emitArgs = ['message'].concat(emitArgs.map(this.decode))
...
Socket.prototype.encode = function (buf, idx, arr) {
  return buf;
};
...
Socket.prototype.decode = function (buf, idx, arr) {
  return buf;
};
