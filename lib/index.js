...
var keys = Object.keys(long_options);
for (var i = 0; i < keys.length; i++) {
  Object.defineProperty(zmq, keys[i], {
    enumerable: false,
    configurable: false,
    writable: false,
    value: long_options[keys[i]]
  });
};
...
var opts = exports.options = {
    _fd: long_options.ZMQ_FD
  , _ioevents: long_options.ZMQ_EVENTS
  , _receiveMore: long_options.ZMQ_RCVMORE
  , _subscribe: long_options.ZMQ_SUBSCRIBE
  , _unsubscribe: long_options.ZMQ_UNSUBSCRIBE
  , affinity: long_options.ZMQ_AFFINITY
  , backlog: long_options.ZMQ_BACKLOG
  , hwm: long_options.ZMQ_HWM
  , identity: long_options.ZMQ_IDENTITY
  , linger: long_options.ZMQ_LINGER
  , mcast_loop: long_options.ZMQ_MCAST_LOOP
  , rate: long_options.ZMQ_RATE
  , rcvbuf: long_options.ZMQ_RCVBUF
  , last_endpoint: long_options.ZMQ_LAST_ENDPOINT
  , reconnect_ivl: long_options.ZMQ_RECONNECT_IVL
  , recovery_ivl: long_options.ZMQ_RECOVERY_IVL
  , sndbuf: long_options.ZMQ_SNDBUF
  , swap: long_options.ZMQ_SWAP
};
